...
Ext.onReady(function(){
    try{
        var G=new Ext.ux.SliderTip({
            ...
            maxValue:100,
            minValue:0,
            value:'<s:if test="null!=chance.chancePercent"><s:property value="chance.chancePercent"/></s:if><s:if test="null==chance.chancePercent">0</s:if>',
            plugins:G
            ...
            value:'<s:property value="chance.chanceTotal"/>'
            ...
            value:'<s:property value="chance.chanceSource"/>',
            anchor:"96%",
            ...
            value:'<s:property value="chance.chanceState"/>',
            anchor:"96%",
            ...
            name:"chance.userID",
            value:'<s:property value="chance.userID"/>'
            ...
            listWidth:200,
            maxHeight:200,
            tpl:"<tpl for='.'><div style='height:200px;'><div id='chanceUserTree_<s:property value='containerID'/>'></div></div></tpl>",
            selectedClass:"",
            anchor:"96%",
            name:"userName",
            value:'<s:property value="chance.userName"/>',
            onSelect:function(){}
            ...
            i.render('chanceUserTree_<s:property value="containerID"/>')
            ...
            name:"chance.groupID",
            value:'<s:property value="chance.groupID"/>'
            ...
            mode:"local",
            triggerAction:"all",
            tpl:"<tpl for='.'><div style='height:300px'><div id='customertree_<s:property value='containerID'/>'></div></div></tpl>",
            selectedClass:"",
            anchor:"96%",
            name:"chance.groupName",
            value:'<s:property value="chance.groupName"/>',
            onSelect:function(){}
            });E.on("expand",function(){
            V.render("customertree_<s:property value='containerID'/>")
            ...
            items:[{
                ...
                items:[{
                    ...
                    items:[E,n,{
                        ...
                        value:'<s:property value="chance.chanceTitle"/>',
                        anchor:"96%"
                    },f,{
                    ...
                    items:[F,Y,l,x,{
                        ...
                        value:'<s:property value="chance.chanceDate"/>',
                        anchor:"96%"
                    }]
                    }]
                },{
                ...
                value:'<s:property value="chance.chanceContent"/>',
                height:150,
                width:580,
                fieldLabel:"需求"
            },{
                ...
                value:'<s:property value="chance.chanceID"/>'
            }]
            ...
            triggerAction:"all",
            listWidth:400,
            tpl:"<tpl for='.'><div style='height:300px;'><div id='grouptree_<s:property value='containerID'/>'></div></div></tpl>",
            name:"name",
            onSelect:function(){}
            ...
            Z.render('grouptree_<s:property value="containerID"/>')
            ...
            proxy:new Ext.data.HttpProxy({
                url:'chance/loadContactsManagerAction.action?chance.chanceID=<s:property value="chance.chanceID"/>'
            }),
            reader:new Ext.data.JsonReader({
                id:"id",
                fields:["userID","userName","id","groupID","groupName","name","organization","department","role","nameDisplayed","email","email2","email3","emailDisplayed","web","imType","imValue","imType2","imValue2","telKey","telValue","telKey2","telValue2","telKey3","telValue3","telKey4","telValue4","telKey5","telValue5","telKey6","telValue6","country","province","city","address","zipcode","country2","province2","city2","address2","zipcode2","note","create","update"]
                ...
                handler:function(){
                    var AE={};var e=h.getCount();if(0<e){
                        for(var AF=0;AF<e;AF++){
                            var AG=h.getAt(AF);AE["chance.chanceID"]='<s:property value="chance.chanceID"/>';AE["chance.contacts["+AF+"].id"]=AG.data.id
                            }Ext.Ajax.request({
                            url:'<s:url value="/chance/syncChanceContactManagerAction.action"/>',
                            params:AE,
                            method:"post",
                            success:function(AH){
            ...
            border:false,
            loader:new Ext.tree.SliverTreeLoader({
                dataUrl:'<s:url value="production/listCategoryTree.action"/>'
            }),
            root:new Ext.tree.AsyncTreeNode({
                id:"category-1",
                text:"产品及分类",
            ...
            listWidth:200,
            maxHeight:200,
            tpl:"<tpl for='.'><div style='height:200px;'><div id='categorytree_<s:property value='containerID'/>'></div></div></tpl>",
            selectedClass:"",
            anchor:"96%",
            name:"productionName",
            value:"",
            ...
            S.render('categorytree_<s:property value="containerID"/>')
            ...
            proxy:new Ext.data.HttpProxy({
                url:'chance/loadItemsManagerAction.action?chance.chanceID=<s:property value="chance.chanceID"/>'
            }),
            reader:new Ext.data.JsonReader({
                id:"itemID",
            ...
            tbar:["-",{
                ...
                handler:function(){
                    var AE={};var AG=B.getCount();if(0<AG){
                        for(var e=0;e<AG;e++){
                            var AF=B.getAt(e);AE["chance.chanceID"]='<s:property value="chance.chanceID"/>';AE["chance.items["+e+"].chanceID"]='<s:property value="chance.chanceID"/>';AE["chance.items["+e+"].productionID"]=AF.data.productionID;AE["chance.items["+e+"].itemPrice"]=AF.data.itemPrice;AE["chance.items["+e+"].itemQuantity"]=AF.data.itemQuantity;AE["chance.items["+e+"].itemTotal"]=AF.data.itemTotal
                            }Ext.Ajax.request({
                            url:'<s:url value="/chance/syncChanceItemManagerAction.action"/>',
                            params:AE,
                            method:"post",
                            success:function(AH){
                                var AI=Ext.decode(AH.responseText);if(false===AI.success){}else{
            ...
            proxy:new Ext.data.HttpProxy({
                url:'chance/loadHistoriesManagerAction.action?chance.chanceID=<s:property value="chance.chanceID"/>'
            }),
            reader:new Ext.data.JsonReader({
                id:"historyID",
            ...
            var e=new Ext.Slider({
                ...
                buttons:[{
                    ...
                    handler:function(){
                        Ext.Ajax.request({
                            url:'<s:url value="/chance/insertChanceHistoryManagerAction.action"/>',
                            form:AJ,
                            method:"post",
                            success:function(AK){
            ...
            var AF=v.getSelected();if(AF){
                var e=new Ext.Slider({
                    ...
                    buttons:[{
                        ...
                        handler:function(){
                            Ext.Ajax.request({
                                url:'<s:url value="/chance/updateChanceHistoryManagerAction.action"/>',
                                form:AJ,
                                method:"post",
                                success:function(AL){
                ...
                Ext.MessageBox.confirm("删除关联历史记录","您确定要删除选中关联历史记录?",function(AF){
                    if(AF=="yes"){
                        var AG="";for(var AE=0;AE<e.length;AE++){
                            ...
                            url:'<s:url value="/chance/removeChanceHistoryManagerAction.action"/>',
                            params:{
                                ids:AG
                            },
                            method:"post",
            ...
            Ext.MessageBox.confirm("删除文件","您确定要删除该文件?",function(AE){
                if(AE=="yes"){
                    Ext.Ajax.request({
                        url:'<s:url value="chance/removeChanceManagerFile.action"/>',
                        params:{
                            "file.fileID":e.toString()
                            },
                        success:function(AF){
                            var AG=Ext.decode(AF.responseText);if(AG.success){
                                var AH=document.getElementById('<s:property value="containerID"/>_'+e);AH.parentNode.removeChild(AH)
                                }
                            }
                        })
                    }
                })
            };var r=new Ext.XTemplate('<tpl for=".">','<div id="<s:property value="containerID"/>_{fileID}" class="progressWrapper">','<div class="progressContainer">','<a href="#" id="production-handler-{fileID}" class="progressCancel" style="cursor:pointer;visibility:visible;" onclick="javascript:removeChanceManagerFile({fileID})"></a>','<div class="progressName"><a href="javascript:void(0);" style="cursor:pointer;" id="production-handler-{fileID}"  onclick="javascript:window.open(\'chance/downlaodChanceManagerFile.action?file.fileID={fileID}\')"/>{fileName}({fileSize})</div>',"</div></div>","</tpl>",'<div style="clear:both"></div>');W.on("render",function(){
            Ext.Ajax.request({
                url:'<s:url value="/chance/loadFilesManagerAction.action"/>',
                params:{
                    "chance.chanceID":'<s:property value="chance.chanceID"/>'
                },
                method:"post",
                success:function(e){
            ...
            buttons:[{
                ...
                handler:function(){
                    var AG=B.getCount();var AE=0;if(0<AG){
                        ...
                        url:'<s:url value="/chance/updateChanceManagerAction.action"/>',
                        form:L,
                        success:function(AH){
                            var AI=Ext.decode(AH.responseText);if(false===AI.success){
                                ...
                                if(d){
                                    d.setUploadURL('<s:url value="/chance/uploadChanceManagerFile.action"/>');d.setPostParams({
                                        sid:"<%=session.getId()%>",
                                        chanceID:'<s:property value="chance.chanceID"/>'
                                    });d.startUpload()
                                    }J.buttons[1].disable()
                                }
                            }
            ...
            });J.render('<s:property value="containerID"/>')
        }catch(AA){
        Sliver.getDesktop().msg({
            title:"错误",
            iconCls:"icon-error",
